...
const question = [
  ...
  "The Chosen Category Is Movies",
  "The Chosen Category Is Cities",
  "The Chosen Category Is TV Shows",
];
...
const categories = [
  ...
  ["DUBAI", "MILAN", "MADRID", "AMSTERDAM", "PRAGUE", "PARIS", "LOS-ANGELES"],
  [
    "SUPERMAN-AND-LOIS",
    "ALCHEMY-OF-SOULS",
    "SQUID-GAME",
...
function showHint() {
  containerHint.innerHTML = `Hint - ${hint}`;
}
